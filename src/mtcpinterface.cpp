...
/****************************************************
          CCN Code
****************************************************/
/*int incoming_interest(struct ccn_closure *selfp, enum ccn_upcall_kind kind, struct ccn_upcall_info *info)
{
int res = 0;
...
void dmtcp::callbackPreCheckpoint()
{
  ...
  dmtcp::userHookTrampoline_preCkpt();
  dmtcp::DmtcpWorker::waitForStage2Checkpoint();
  JASSERT_STDERR <<"Received Interest for checkpoint, checkpoint taken!" 
         <<"\n";
}
